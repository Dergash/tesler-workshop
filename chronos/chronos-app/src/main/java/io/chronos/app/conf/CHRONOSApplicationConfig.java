...
@Import({
		...
		CHRONOSPersistenceConfig.class
})
...
@BeanScan(value = {"io.chronos"})
public class CHRONOSApplicationConfig implements SchedulingConfigurer {
...
private final CHRONOSConfiguration configuration;
	...
	public ServletRegistrationBean api() {
		return createRegistration("api", CHRONOSAPIConfig.class, "/api/v1/*");
	}
